...
let ClosePostReportService = class ClosePostReportService {
    constructor(usersRepository, reportsRepository) {
        this.usersRepository = usersRepository;
        this.reportsRepository = reportsRepository;
    }
    async execute({ id, action, feedback, user_id, }) {
        ...
        if (!report) {
            throw new apollo_server_1.ApolloError('Report not found', '400');
        }
